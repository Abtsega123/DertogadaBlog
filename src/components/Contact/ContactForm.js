...
export default function ContactForm() {
  ...
  return (
    ...
    >
      ...
      />
      and I'm eager to dive into an exciting project with you. Drop me a line via email at 
      <input type="email" placeholder="your@email" {...register("email", {})}  className="outline-none border-0 p-0 mx-2 focus:ring-0 placeholder:text-center placeholder:text-lg border-b border-gray 
        focus:border-gray bg-transparent"/>
     or feel free to connect with me directly on 
      <input
        type="tel"
        ...
        focus:border-gray bg-transparent"
      />
      Let's turn ideas into reality! Here's a sneak peek into my project: <br />
      ...
      <br /><br />🚀 Looking forward to connecting and crafting something amazing together! 🌟</form>
  );
}
